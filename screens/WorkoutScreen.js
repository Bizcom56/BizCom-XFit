  ...
  return (
    <>
      ...
      <TouchableOpacity onPress={() => {
        ...
        setCompleted([]);
      }} style={{ backgroundColor: "#fb8500", padding: 12, marginHorizontal: 15, marginVertical: 20, borderRadius: 50}}>
        <Text style={{ textAlign: "center", color: "#FFF", fontWeight: "bold", fontSize: 20 }}> START</Text>
      </TouchableOpacity>
    </>
  )
}
